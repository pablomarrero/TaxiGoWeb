package uy.taxigo.web.web.rest;

import uy.taxigo.web.TaxiGoWebApp;
import uy.taxigo.web.domain.Authority;
import uy.taxigo.web.domain.User;
import uy.taxigo.web.repository.UserRepository;
import uy.taxigo.web.repository.search.UserSearchRepository;
import uy.taxigo.web.security.AuthoritiesConstants;
import uy.taxigo.web.service.MailService;
import uy.taxigo.web.service.UserService;
import uy.taxigo.web.service.dto.UserDTO;
import uy.taxigo.web.service.mapper.UserMapper;
import uy.taxigo.web.web.rest.errors.ExceptionTranslator;
import uy.taxigo.web.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = TaxiGoWebApp.class)
